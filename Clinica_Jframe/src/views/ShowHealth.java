...
public class ShowHealth extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ShowHealth frame = new ShowHealth();
	...
	public ShowHealth() {
		...
		JLabel lblNewLabel = new JLabel("LISTA DE SEGUROS");
		...
		btnDelete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					String query = "DELETE FROM healthinsurance WHERE id = ?";
		...
		JLabel lblNewLabel_1 = new JLabel("Cod para eliminar");
	...
	private void fillTable() {
		try {
			...
			ResultSet resultSet = statement.executeQuery("SELECT * FROM healthinsurance");
			...
			for (int i = 1; i <= columnCount; i++) {
				...
				case "id":
					...
					break;
				case "policynumber":
					newColumnName = "Numero de poliza";
					break;
				case "insurancecompany":
					newColumnName = "Compañia";
					break; 
				case "coveragedetails":
					newColumnName = "Detalles";
					break;
				case "patient_id":
					newColumnName = "Cod. Paciente";
					break;
				default:
